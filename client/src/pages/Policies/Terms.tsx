    ...
    <div className="policy_outer_container">
      <div className={`policy_main_container ${darkMode ? "dark" : ""}`}>
        ...
        <p>
          ...
          conditions. Do not continue to use Hollywoodle if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing Hollywoodle, you agreed to
          use cookies in agreement with the Hollywoodle's Privacy Policy.{" "}
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, Hollywoodle and/or its licensors own the
          intellectual property rights for all material on Hollywoodle. All
          intellectual property rights are reserved. You may access this from
          Hollywoodle for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from Hollywoodle</li>
          <li>Sell, rent or sub-license material from Hollywoodle</li>
          <li>Reproduce, duplicate or copy material from Hollywoodle</li>
          <li>Redistribute content from Hollywoodle</li>
        </ul>
        <p>
        ...
        <p>
          ...
          Hollywoodle does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Hollywoodle,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Hollywoodle
          shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          Hollywoodle reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant Hollywoodle a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Hollywoodle; and (d) the link
        ...
        <p>
          No use of Hollywoodle's logo or other artwork will be allowed for
        ...
        <div
          className={`policy_bottom_buttons_container ${
            darkMode ? "dark" : ""
          }`}
        >
          <Link className="next_policy_container" to="/privacy">
